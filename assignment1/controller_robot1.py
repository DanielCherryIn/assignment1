...
class ControllerRobot1(Node):
    ...
    def __init__(self):
        ...
        self.cluster_distance_threshold = 0.1  # Max distance between points in a cluster
    ...
    def control_robot(self, cmd, msg):
        ...
        if robot2_missing or robot2_too_far:
            ...
            self.get_logger().info(f'Robot2 detected. Wall-following - v: {v_wall:.3f}, w: {w_wall:.3f}')
